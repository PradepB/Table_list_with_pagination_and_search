...
var AppComponent = /** @class */ (function () {
    function AppComponent(ServicesService, router) {
        this.ServicesService = ServicesService;
        this.router = router;
    }
    AppComponent.prototype.getAllSongs = function () {
        var _this = this;
        this.ServicesService.getAllChannel().subscribe(function (data) {
            _this.chennal_List = data;
            console.log(_this.chennal_List);
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__services_service__ = __webpack_require__("./src/app/services.service.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_6__angular_forms__["a" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_0__angular_router__["b" /* RouterModule */],
                __WEBPACK_IMPORTED_MODULE_3__app_routing_module__["a" /* AppRoutingModule */],
                __WEBPACK_IMPORTED_MODULE_9_ngx_pagination__["a" /* NgxPaginationModule */]
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_8__services_service__["a" /* ServicesService */]],
...
var ServicesService = /** @class */ (function () {
    ...
    ServicesService.prototype.getAllChannel = function () {
        return this.http.get(this.domain + 'Channel/AllChannel').map(function (res) { return res.json(); });
    };
